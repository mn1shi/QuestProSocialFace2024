...
namespace Ubiq.Avatars
{
    ...
    /// </summary>
    public class OVR_AvatarManager : MonoBehaviour
    {
        ...
        /// </summary>
        public OVR_Avatar LocalAvatar { get; private set; }
        public RoomClient RoomClient { get; private set; }

        public IEnumerable<OVR_Avatar> Avatars
        {
            get
            {
        ...
        public class AvatarDestroyedEvent : UnityEvent<OVR_Avatar>
        {
        }

        public class AvatarCreatedEvent : ExistingListEvent<OVR_Avatar>
        {
        }
        ...
        private Dictionary<IPeer, OVR_Avatar> playerAvatars = new Dictionary<IPeer, OVR_Avatar>();
        ...
        {
            var avatar = gameObject.GetComponentInChildren<OVR_Avatar>();
            avatar.SetPeer(peer);
            ...
            if (peer == RoomClient.Me)
            {
                ...
                gameObject.GetComponentInChildren<OVRBody>().enabled = true;
                gameObject.GetComponentInChildren<OVRUnityHumanoidSkeletonRetargeter>().enabled = true;
            ...
            else
            {
                ...
                gameObject.GetComponentInChildren<OVRBody>().enabled = false;
                gameObject.GetComponentInChildren<OVRUnityHumanoidSkeletonRetargeter>().enabled = false;
            }
        ...
        /// </summary>
        public OVR_Avatar FindAvatar(IPeer Peer)
        {
